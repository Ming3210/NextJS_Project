    ...
    return (
        <header className="header flex w-full justify-between h-16 border-solid border-0 border-b-4 bg-white border-b-red-600 ">
         ...
         <div className="header__left flex w-full items-center ml-5">
            ...
            <div className="header__searchbox flex items-center">
              <svg 
              ...
              <input
                ...
                className="header__searchinput border-2 p-[30px] border-gray-300 rounded-full h-10 w-[250px] py-2"
        ...
        <div className="header__right  flex gap-5 left-header">
            ...
            />
              <div className='flex justify-center items-center mr-10'>
                    <img onClick={login} src="https://th.bing.com/th/id/OIP.z3fa8PjEnvzg4bhW61tEOwAAAA?rs=1&pid=ImgDetMain" className='rounded-full w-[40px] h-[40px]' alt="" />
                  </div>
            {/* <HeaderRightIcon
            //   onClick={logout}
              icon={
